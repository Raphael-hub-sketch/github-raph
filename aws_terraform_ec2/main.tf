...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-03784fad4b0c97597"
		"eu-north-1" = "ami-085346923bc996d00"
		"ap-south-1" = "ami-0af0720e4293f9408"
		"eu-west-3" = "ami-07db797d757826c09"
		"eu-west-2" = "ami-0da853007f4918d65"
		"eu-west-1" = "ami-027eedaa42be364b3"
		"ap-northeast-2" = "ami-07f84f4d37e584f98"
		"me-south-1" = "ami-010c7a952e8bab4d7"
		"ap-northeast-1" = "ami-0e7ac451d6fb4a2d3"
		"sa-east-1" = "ami-019385ff75b4ef8c8"
		"ca-central-1" = "ami-04c193ae3a5d76b8c"
		"ap-east-1" = "ami-050d7df8956bbfbb2"
		"ap-southeast-1" = "ami-070f365377081c7e0"
		"ap-southeast-2" = "ami-0439facf6e0249072"
		"us-east-1" = "ami-0ac927e47991522b7"
		"us-east-2" = "ami-096e497411b6d2794"
		"us-west-1" = "ami-0e0a50a6ba3aace31"
		"us-west-2" = "ami-0a4469c6fed245c9c"
  }
}
